...
[Devotio](https://github.com/AxylOS-OS/devotio) is a secure disk erasure tool based on **DoD 5220.22 M**, **ATA Secure Erase** and **encryption-based destruction**.
...
Devotio is included in AxylOS Live ISO. You can use Devotio to erase devices also on other operating systems.

You can burn it on a device and land on AxylOS Live Environment. Then, run:
```shell
sudo devotio
```
