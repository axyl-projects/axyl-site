---
title: AxylOS Welcome
description: AxylOS Welcome overview.
---
import ImageComponent from "@components/ImageComponent.astro";
import ThemedImage from '@components/ThemedImage.astro';

AxylOS Welcome is the official AxylOS welcome app aimed to configure the system installation as you wish by allowing you to select any settings and resource you need, and to manage Cyber Security Roles and Hacking Platform tools.

AxylOS Welcome consists three tabs
* Welcome
* Information
* Credits
...
While **Information** contains useful information to start on AxylOS, the **Welcome** tab is a little more elaborated. Its contents are discussed in the next sections.

## Live Environment

Landing on the Live Environment, **AxylOS Welcome** application is automatically run.

![AxylOS Welcome Install](@assets/images/AxylOS-welcome-install.png)

### Install

Currently the installation by TUI (Terminal User Interface) is available by the **Install AxylOS (TUI)** button. In the future the Welcome application will feature also a GUI installation.
...
**Package Update** will upgrade all the packages installed iin your system. **Update Mirrors** will find the fastest mirrors for your connection in order to speed up the retrieve of the packages to install for AxylOS Arch. In case of AxylOS Nix, it will update all Nix channels.

## Post-Install Environment

Once AxylOS is installed, **AxylOS Welcome** application is automatically run.

![AxylOS Welcome Post](@assets/images/AxylOS-welcome-post.png)
...
**HTB Update** button is used for setting your [Hack The Box](https://www.hackthebox.com/) API token in order to play Hack The Box machines directly inside of AxylOS.
You can retrieve your HTB API token by login to [Hack The Box website](https://app.hackthebox.com/) -> click on your user account on top-right -> **My Profile** -> **Profile Settings** tab -> under **App Tokens**, click on **Create App Token**. Assign a **Token Name** and a **Expires In** value and click on **Create**. Take the output string and save it in a secure way. It will be used for setting Hack The Box inside of AxylOS.

On AxylOS Welcome, when clicked for the first time on **HTB Update** button, you will get the following message:
```
...
```
and you are able to play Hack The Box machines in AxylOS.

{/*

### Tool Recipe

![AxylOS Welcome Tool Recipe](@assets/images/AxylOS-welcome-toolrecipe.png)

It shows all the application and utility commands in AxylOS.
...
![AxylOS Welcome Hacking Variables](@assets/images/AxylOS-welcome-variables.png)

## Common Resources

The remaining buttons are common to both of the views and are related to the AxylOS project and the community:
* **Release info** shows information about the latest release
* **AxylOS project** is linked to the AxylOS website
* **Open a ticket** allows you to open an issue ticket in case you need to report an issue
* **Discord** will carry you to the AxylOS Discord community
* **Video Demo** shows a showcase video about AxylOS
* **Donate** allows you to support the project
* **Wiki** brings you to the AxylOS official documentation
* **Quit** will close AxylOS Welcome app
