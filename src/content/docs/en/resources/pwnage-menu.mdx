---
title: PWNage Menu
description: Details about PWNage Menu in AxylOS.
---
...
One of the most interesting features of AxylOS is the deep **integration** with [Hack The Box](https://app.hackthebox.com) platform, accessible by PWNage menu. AxylOS gives the possibility to play Hack The Box machines directly on the OS environment in a **quick** and **comfortable** manner. It offers:
...
The set of tools that manages the Hack The Box environment needs of the App Token of the Hack The Box user that can be set as described in [AxylOS Welcome section](/en/resources/AxylOS-welcome/#htb-update) or by calling `htb-update` command.
