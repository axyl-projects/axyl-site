...
```
To fix this, boot again by USB to the AxylOS Live Environment and mounting the devices as done before, like:
If your existing Linux distribution is based on BTRFS file system, run:
```shell
sudo mount -o subvol=@ /dev/sda3 /mnt
sudo mount -o subvol=@home /dev/sda3 /mnt/home
...
![AxylOS Snapshots](@assets/images/AxylOS-snapshots.png)

Choose the **snapshot** you want to restore

![AxylOS Snapshots Selection](@assets/images/AxylOS-snapshots-selection.png)

and select the **Linux Kernel** to run

![AxylOS Snapshots Run](@assets/images/AxylOS-snapshots-run.png)
