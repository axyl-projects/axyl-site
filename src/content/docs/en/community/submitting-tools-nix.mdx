...
If you would like to ask to implement a specific tool inside a Cyber Role, [open a request](https://github.com/AxylOS-OS/AxylOS-nix/issues/new/choose) and it will be evaluated.
