...
description: How to install AxylOS as baremetal.
---
import ImageComponent from "@components/ImageComponent.astro";
import ThemedImage from '@components/ThemedImage.astro';

The following section will guide you through the steps to install AxylOS as baremetal by covering all the possible choices you could set.

## Install AxylOS as single boot

Once prepared the setup as described in [Installation prepare](/en/installation/prepare-install/), and rebooted the system with your plugged USB drive containing the AxylOS installation media, according to your boot mode (EFI or BIOS/Legacy), you will be shown:
