...
Finally, run the virtual machine and install AxylOS as explained in [Installing as single boot](/en/installation/install-single-boot/) chapter.
:::note
AxylOS automatically recognizes if you are using a virtualized environment so you don't need to install VMware Tools because the system will do automatically for you during the OS installation.
:::
<ImageComponent />
