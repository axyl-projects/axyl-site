---
title: Cinnamon
description: Cinnamon environment in AxylOS.
---
...
In AxylOS, Cinnamon provides a simple environment and quick access to cyber resources.
...
Here are reported some useful **keybindings** set by default in AxylOS Cinnamon.
