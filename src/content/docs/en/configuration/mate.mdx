---
title: MATE
description: MATE environment in AxylOS.
---
...
In AxylOS, MATE provides quick access to cyber resources.
...
Here are reported some useful **keybindings** set by default in AxylOS MATE.
