---
title: Bspwm
description: Bspwm environment in AxylOS.
---
...
In AxylOS, Bspwm shows different rices to fit the best workspace environment the user would like to work on.
...
#### Application Menu
By clicking on AxylOS or Arch logo icon, or by pressing **SUPER + SPACE** on your keyboard, the Application Menu will spawn. Here, you can find and open any installed application you wish to run.
...
Here are reported some useful **keybindings** set by default in AxylOS Bspwm.
...
| **Shift + ALT + W** | Open AxylOS Welcome |
