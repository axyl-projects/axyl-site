---
title: XFCE
description: XFCE environment in AxylOS.
---
...
In AxylOS, XFCE has been deployed in different environments.
...
Here are reported some useful **keybindings** set by default in AxylOS XFCE.
