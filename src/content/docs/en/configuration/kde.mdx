---
title: KDE Plasma
description: KDE Plasma environment in AxylOS.
---
...
In AxylOS, KDE Plasma provides the essential elements to perform your activities.
...
Here are reported some useful **keybindings** set by default in AxylOS KDE Plasma.
