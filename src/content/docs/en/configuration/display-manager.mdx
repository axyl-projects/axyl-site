...
description: AxylS Display Managers.
---
import ImageComponent from "@components/ImageComponent.astro";
import ThemedImage from '@components/ThemedImage.astro';

An important element in the system is the **Display Manager** that manages the login phase. By AxylOS installer, users can choose among different Display Managers as they wish under the “Login Manager” pane. Indeed, currently AxylOS offers three solutions: **GDM**, **LightDM** and **SDDM**.
